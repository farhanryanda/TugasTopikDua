...
import com.farhanryanda.tugastopikdua.databinding.ActivitySeriazableBinding

class SeriazableActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySeriazableBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySeriazableBinding.inflate(layoutInflater)
        setContentView(binding.root)

        var data = intent.getSerializableExtra("data") as DataSerializable
